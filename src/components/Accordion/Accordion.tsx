...
export default function Accordion({
  ...
  return (
    <div className="flex flex-col grow w-[17rem] max-w-[22rem] h-[26rem] bg-white text-sm font-regular border p-4 mr-6 mb-6 border-ssTheme-orange minDesktop:border-ssTheme-darkerBlue">
